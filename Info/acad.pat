...
;;
;;  Использование данного программного обеспечения регулируется положениями лицензионного договора Autodesk, 
;;  предоставленного во время установки или загрузки или иным способом 
;;  предоставленного в месте с данным программным продуктом в электронном или печатном виде.
;;
;;  Версия 2.0
;;  Образцы штриховок AutoCAD
;;
;;
...
;;  в раздел "Пользовательские образцы штриховок". Этот раздел расположен
;;  в конце файла.
;;


;; Замечание: Первым идет фиктивное описание образца для сплошной заливки.
*SOLID, Заливка
45, 0,0, 0,.125
*ANGLE, Уголки
0, 0,0, 0,.275, .2,-.075
...
*ANSI33, ANSI бронза, латунь, медь
45, 0,0, 0,.25
45, .176776695,0, 0,.25, .125,-.0625
*ANSI34, ANSI пластик, резина
45, 0,0, 0,.75
45, .176776695,0, 0,.75
45, .353553391,0, 0,.75
45, .530330086,0, 0,.75
...
*ANSI37, ANSI свинец, цинк, магний, звуковая/тепловая/электрическая изоляция
45, 0,0, 0,.125
135, 0,0, 0,.125
*ANSI38, ANSI алюминий
45, 0,0, 0,.125
135, 0,0, .25,.125, .3125,-.1875
;;
;;  Следующие образцы штриховки AR-xxxxx
;;  используются в архитектурно-строительном проектировании
;;
*AR-B816, 8x16 Кирпичная кладка на фасадах
0,       0,0,      0,8
90,      0,0,      8,8,                          8,-8
*AR-B816C, 8x16 Кирпичная кладка на фасадах
0,       0,0,      8,8,                         15.625,-.375
0,      -8,.375,   8,8,                         15.625,-.375
90,      0,0,      8,8,                        -8.375,7.625
90,     -0.375,0,  8,8,                        -8.375,7.625
*AR-B88, 8x8 Кирпичная кладка на фасадах
0,       0,0,      0,8
90,      0,0,      8,4,                          8,-8
*AR-BRELM, Кирпичная кладка на фасадах
...
*AR-BRSTD, Стандартная кирпичная кладка на фасадах
0,       0,0,      0,2.667
...
*AR-HBONE, Стандартная кирпичная кладка "в елку"
45,      0,0,      4,4,                          12,-4
135,     2.828427125,2.828427125,  4,-4,         12,-4
*AR-PARQ1, 2x12 Паркетный пол: узор 12x12
90,      0,0,      12,12,                        12,-12
90,      2,0,      12,12,                        12,-12
90,      4,0,      12,12,                        12,-12
90,      6,0,      12,12,                        12,-12
...
90, .5,0, 0,1, .25,-.25
90, .75,0, 0,1, .25,-.25
*BRASS, Материал из латуни
0, 0,0, 0,.25
0, 0,.125, 0,.25, .125,-.0625
*BRICK, Кирпич или материал для кладки
0, 0,0, 0,.25
90, 0,0, 0,.5, .25,-.25
90, .25,0, 0,.5, -.25,.25
*BRSTONE, Кирпич и камень
0, 0,0, 0,.33
90, .9,0,  .33,.5,    .33,-.33
90, .8,0,  .33,.5,    .33,-.33  
0, .9,.055,  .5,.33,  -.9, .1
...
*DASH, Штриховые линии
0, 0,0, .125,.125, .125,-.125
*DOLMIT, Наслоения геологических пород
0, 0,0, 0,.25
...
*HOUND, Клетчатый узор
0, 0,0, .25,.0625, 1,-.5
90, 0,0, -.25,.0625, 1,-.5
*INSUL, Изоляционный материал
0, 0,0, 0,.375
0, 0,.125, 0,.375, .125,-.125
0, 0,.25, 0,.375, .125,-.125
;;
;;  Образцы штриховок в соответствии с типами линий ISO/DIS 12011
;;
;;  (Ширина * 5 = Расстояние между линиями)
;;
;;  Базой для определений служило перо с шириной 1 мм. Для использования
;;  других перьев стандарта ISO/DIS 12011, необходимо использовать
;;  использовать соответствующий коэффициент 
;;  масштаба (например, ширина пера 0.5 мм ->
;;  лмасштаб 0.5).
;;
*ACAD_ISO02W100, штриховая
0, 0,0, 0,5, 12,-3
*ACAD_ISO03W100, штриховая с длинными промежутками
0, 0,0, 0,5, 12,-18
*ACAD_ISO04W100, штрихпунктирная с длинными штрихами
0, 0,0, 0,5, 24,-3,.5,-3
*ACAD_ISO05W100, штрихпунктирная с длинными штрихами и двумя точками
0, 0,0, 0,5, 24,-3,.5,-3,.5,-3
*ACAD_ISO06W100, штрихпунктирная с длинными штрихами и тремя точками
0, 0,0, 0,5, 24,-3,.5,-3,.5,-6.5
0, 0,0, 0,5, -34,.5,-3
*ACAD_ISO07W100, пунктирная
0, 0,0, 0,5, .5,-3
*ACAD_ISO08W100, штриховая с чередованием длинных и коротких штрихов
0, 0,0, 0,5, 24,-3,6,-3
*ACAD_ISO09W100, штриховая с длинным и двумя короткими штрихами
0, 0,0, 0,5, 24,-3,6,-3,6,-3
*ACAD_ISO10W100, штрихпунктирная
0, 0,0, 0,5, 12,-3,.5,-3
*ACAD_ISO11W100, штрихпунктирная с двумя штрихами
0, 0,0, 0,5, 12,-3,12,-3,.5,-3
*ACAD_ISO12W100, штрихпунктирная с двумя точками
0, 0,0, 0,5, 12,-3,.5,-3,.5,-3
*ACAD_ISO13W100, штрихпунктирная с двойными штрихами и точками
0, 0,0, 0,5, 12,-3,12,-3,.5,-6.5
0, 0,0, 0,5, -33.5,.5,-3
*ACAD_ISO14W100, штрихпунктирная с тремя точками
0, 0,0, 0,5, 12,-3,.5,-3,.5,-6.5
0, 0,0, 0,5, -22,.5,-3
*ACAD_ISO15W100, штрихпунктирная с двумя штрихами и тремя точками
0, 0,0, 0,5, 12,-3,12,-3,.5,-10
0, 0,0, 0,5, -33.5,.5,-3,.5,-3
;;
;; конец определения образцов штриховки ACAD_ISO
;;
*LINE, Параллельные горизонтальные линии
0, 0,0, 0,.125
*MUDST, Грязь и песок
0, 0,0, .5,.25, .25,-.25,0,-.25,0,-.25
*NET, Горизонтальная / вертикальная сетка
0, 0,0, 0,.125
90, 0,0, 0,.125
*NET3, Сетчатый узор 0-60-120
0, 0,0, 0,.125
60, 0,0, 0,.125
120, 0,0, 0,.125
*PLAST, Пластмассовый материал
0, 0,0, 0,.25
0, 0,.03125, 0,.25
0, 0,.0625, 0,.25
*PLASTI, Пластмассовый материал
0, 0,0, 0,.25
0, 0,.03125, 0,.25
0, 0,.0625, 0,.25
0, 0,.15625, 0,.25
...
*SQUARE,Небольшие выровненные квадраты
0, 0,0, 0,.125, .125,-.125
...
*STEEL, Стальной материал
45, 0,0, 0,.125
45, 0,.0625, 0,.125
*SWAMP, Заболоченная местность
...
*TRANS, Теплопроводный материал
0, 0,0, 0,.25
0, 0,.125, 0,.25, .125,-.125
*TRIANG, Равносторонние треугольники
60, 0,0, .1875,.324759526, .1875,-.1875
120, 0,0, .1875,.324759526, .1875,-.1875
0, -.09375,.162379763, .1875,.324759526, .1875,-.1875
*ZIGZAG, Ступенчатый узор
0, 0,0, .125,.125, .125,-.125
90, .125,0, .125,.125, .125,-.125

;;  
;;  Пользовательские образцы штриховок
;;  Все вновь описываемые образцы штриховок рекомендуется добавлять
;;  именно в этот раздел. Это гарантирует корректность переноса
;;  их в будущие версии AutoCAD. Если в процессе переноса в файле
;;  будут обнаружены повторяющиеся описания образцов штриховок,
;;  приоритет будет иметь то из них, которое расположено последним.
;; 
;;
